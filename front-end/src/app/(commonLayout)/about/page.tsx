...
const values = [
  {
    icon: '💎',
    title: 'Excellence',
    description: 'We maintain the highest standards in every property and service we offer.',
  },
  {
    icon: '🤝',
    title: 'Integrity',
  ...
  },
  {
    icon: '🎯',
    title: 'Innovation',
    description: 'We leverage cutting-edge technology to enhance the property buying experience.',
  },
  {
    icon: '🌟',
    title: 'Luxury',
    description: 'Every detail is curated to deliver an unparalleled luxury experience.',
  },
];
    ...
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-white dark:from-gray-900 dark:to-black">
      ...
      <section className="relative min-h-[70vh] flex items-center justify-center overflow-hidden">
        ...
        <div className="absolute inset-0">
          ...
          <div className="absolute bottom-20 right-10 w-96 h-96 bg-amber-400/20 dark:bg-amber-500/10 rounded-full blur-3xl animate-parallax-float" style={{ animationDelay: '2s' }}></div>
          <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] bg-gradient-to-r from-amber-200/10 to-orange-200/10 dark:from-amber-900/5 dark:to-orange-900/5 rounded-full blur-3xl"></div>
        </div>
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-4 text-center">
          <div className="inline-block mb-6 px-6 py-2 bg-white/80 dark:bg-gray-900/80 backdrop-blur-xl rounded-full border border-white/20 dark:border-gray-800/20 shadow-lg">
            <span className="text-amber-600 dark:text-amber-400 font-semibold">About Us</span>
          </div>
          ...
          <p className="text-xl md:text-2xl text-gray-600 dark:text-gray-400 leading-relaxed max-w-3xl mx-auto">
            For over 15 years, we've been connecting discerning clients with the world's most exceptional properties.
          </p>
        </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-6">
              ...
              <div className="space-y-4 text-gray-600 dark:text-gray-400 leading-relaxed">
                <p>
                  Founded in 2010, Luxury Real Estate began with a simple vision: to transform the way people experience premium properties. What started as a boutique agency has grown into a global leader in luxury real estate.
                </p>
                <p>
                  Our journey has been marked by unwavering commitment to excellence, innovation, and client satisfaction. We've facilitated over 10,000 property transactions, helping families find their dream homes and investors discover exceptional opportunities.
                </p>
                <p>
                  Today, we continue to push boundaries, leveraging cutting-edge technology and deep market expertise to deliver unparalleled service in the luxury real estate sector.
                </p>
              </div>
            </div>
            <div className="relative h-[500px] bg-gradient-to-br from-amber-100 to-amber-200 dark:from-amber-900/20 dark:to-amber-800/20 rounded-3xl overflow-hidden shadow-2xl">
              <div className="absolute inset-0 flex items-center justify-center">
                <svg className="w-32 h-32 text-amber-600 dark:text-amber-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      <section className="py-20 px-4">
        <div className="max-w-4xl mx-auto">
          <div className="bg-gradient-to-r from-amber-500 to-amber-600 rounded-3xl p-12 text-center shadow-2xl relative overflow-hidden">
