...
const contactMethods = [
  ...
  },
  {
    ...
    title: 'Email',
    value: 'contact@luxury.com',
    description: 'We reply within 24 hours',
    link: 'mailto:contact@luxury.com',
  },
  {
    icon: (
      <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
const faqs = [
  {
    ...
    answer: 'We serve major metropolitan areas across the United States, with offices in New York, Los Angeles, and Miami.',
  },
  {
    question: 'How long does the buying process take?',
    answer: 'Typically 30-60 days from offer acceptance to closing, depending on financing and inspection requirements.',
  },
  {
    question: 'Do you offer virtual property tours?',
    answer: 'Yes, we provide comprehensive virtual tours with 3D walkthroughs for all our luxury properties.',
  },
];
