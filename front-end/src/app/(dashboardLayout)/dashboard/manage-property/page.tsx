...
const ManagePropertyPage = () => {
  const stats = [
    { icon: FiHome, label: 'Total Properties', value: '24', change: '+12%', color: 'from-blue-500 to-cyan-500' },
    { icon: FiTrendingUp, label: 'Active Listings', value: '18', change: '+8%', color: 'from-purple-500 to-pink-500' },
    { icon: FiDollarSign, label: 'Total Value', value: '$12.5M', change: '+15%', color: 'from-green-500 to-emerald-500' },
    { icon: FiEye, label: 'Total Views', value: '3.2K', change: '+23%', color: 'from-orange-500 to-red-500' },
  ];
  ...
  return (
    <div className="min-h-screen p-6 lg:p-8 space-y-8">
      ...
      {/* Properties Table */}
      <div className="relative overflow-hidden rounded-3xl bg-white/5 backdrop-blur-xl border border-white/10 p-6 lg:p-8">
        <PropertyTable />
      </div>
    </div>
  );
