  ...
  return (
    <div className="relative w-full h-[500px] bg-linear-to-br from-amber-50 to-orange-50 dark:from-gray-800 dark:to-gray-900 rounded-3xl overflow-hidden border border-white/20 dark:border-gray-700/20 shadow-2xl">
        ...
        <svg className="w-full h-full" viewBox="0 0 100 100" preserveAspectRatio="none">
          <defs>
            <pattern id="grid" width="10" height="10" patternUnits="userSpaceOnUse">
              <path d="M 10 0 L 0 0 0 10" fill="none" stroke="currentColor" strokeWidth="0.5" className="text-amber-400 dark:text-amber-600"/>
            </pattern>
          </defs>
      ...
      <svg className="absolute inset-0 w-full h-full pointer-events-none">
        <line x1="15%" y1="45%" x2="35%" y2="35%" stroke="currentColor" strokeWidth="2" strokeDasharray="5,5" className="text-amber-400/50 dark:text-amber-600/50" />
        <line x1="85%" y1="35%" x2="80%" y2="70%" stroke="currentColor" strokeWidth="2" strokeDasharray="5,5" className="text-amber-400/50 dark:text-amber-600/50" />
      </svg>
