  ...
  return (
    <div ref={ref} className="grid grid-cols-2 md:grid-cols-4 gap-6">
      {stats.map((stat, idx) => (
        ...
        >
          <div className="text-4xl md:text-5xl font-bold bg-linear-to-r from-blue-500 to-purple-600 dark:from-amber-500 dark:to-amber-600 bg-clip-text text-transparent mb-2">
