    ...
    <section className='relative min-h-screen flex items-center justify-center px-4 sm:px-6 lg:px-8 pt-20'>
      ...
      <div className='relative max-w-7xl mx-auto text-center'>
        <h1 className='text-5xl sm:text-6xl lg:text-7xl font-bold tracking-tight mb-6'>
          ...
          <span className='block bg-linear-to-r from-amber-500 to-amber-600 bg-clip-text text-transparent'>
            Dream Property
          </span>
        </h1>
        ...
        <div className='flex flex-col sm:flex-row gap-4 justify-center'>
          <button className='px-8 py-4 bg-linear-to-r from-amber-500 to-amber-600 text-white font-semibold rounded-full hover:shadow-2xl hover:scale-105 transition-all duration-300'>
            Explore Properties
          </button>
