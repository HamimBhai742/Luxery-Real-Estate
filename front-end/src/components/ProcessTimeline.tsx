...
export default function ProcessTimeline({ steps }: ProcessTimelineProps) {
  ...
  return (
    <div ref={timelineRef} className="relative">
      {/* Timeline Line */}
      <div className="absolute left-8 md:left-1/2 top-0 bottom-0 w-0.5 bg-linear-to-b from-blue-500 via-purple-400 to-purple-300 dark:from-amber-600 dark:via-amber-500 dark:to-amber-400"></div>
              ...
              <div className="absolute left-8 md:left-1/2 md:-translate-x-1/2 flex items-center justify-center">
                <div
                  className={`w-16 h-16 rounded-full flex items-center justify-center font-bold text-xl transition-all duration-500 ${
                    activeStep >= idx
                      ? 'bg-linear-to-br from-blue-500 to-purple-600 dark:from-amber-400 dark:to-amber-600 text-white scale-110 shadow-lg shadow-purple-500/50 dark:shadow-amber-500/50'
