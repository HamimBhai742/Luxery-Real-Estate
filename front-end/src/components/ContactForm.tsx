      ...
      <div className='grid grid-cols-1 md:grid-cols-2 gap-6'>
        ...
        <div className='group'>
          ...
          <input
            ...
            className='w-full px-4 py-3 rounded-xl border border-gray-300 dark:border-gray-700 bg-white/50 dark:bg-gray-800/50 backdrop-blur-sm text-gray-900 dark:text-white placeholder-gray-400 focus:ring-2 focus:ring-blue-500 dark:focus:ring-amber-500 focus:border-transparent transition-all duration-300 group-hover:border-blue-300 dark:group-hover:border-amber-300 group-hover:shadow-lg'
      ...
      <div className='grid grid-cols-1 md:grid-cols-2 gap-6'>
        ...
        <div className='group'>
          ...
          <select
            ...
            className='w-full px-4 py-3 rounded-xl border border-gray-300 dark:border-gray-700 bg-white/50 dark:bg-gray-800/50 backdrop-blur-sm text-gray-900 dark:text-white focus:ring-2 focus:ring-blue-500 dark:focus:ring-amber-500 focus:border-transparent transition-all duration-300 group-hover:border-blue-300 dark:group-hover:border-amber-300 group-hover:shadow-lg'
          >
