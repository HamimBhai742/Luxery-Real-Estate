          ...
          <div className="md:hidden divide-y divide-gray-200 dark:divide-white/10">
            {[...Array(5)].map((_, index) => (
              <div key={index} className="p-4 space-y-3">
                <div className="flex items-center gap-3">
                  <div className="w-20 h-20 bg-gray-300 dark:bg-gray-600 rounded-lg animate-pulse"></div>
                ...
                <div className="flex gap-2">
                  <div className="flex-1 h-9 bg-gray-300 dark:bg-gray-600 rounded-lg animate-pulse"></div>
                  <div className="flex-1 h-9 bg-gray-300 dark:bg-gray-600 rounded-lg animate-pulse"></div>
                </div>
              </div>
            ))}
