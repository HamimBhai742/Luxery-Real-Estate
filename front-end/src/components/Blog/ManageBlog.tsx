...
import { FiEdit3, FiTrash2, FiEye, FiSearch, FiFilter, FiPlus, FiCalendar, FiUser, FiTag } from 'react-icons/fi';
...
const EditModal: React.FC<EditModalProps> = ({ blog, isOpen, onClose, onUpdate }) => {
...
const ManageBlog = () => {
  ...
  useEffect(() => {
    const mockBlogs: Blog[] = [
      ...
      },
      {
        ...
        excerpt: 'Learn effective strategies for investing in premium real estate.',
        content: 'Lorem ipsum dolor sit amet, consectetur adipiscing elit...',
        category: 'Investment Guide',
        tags: ['investment', 'strategy', 'premium'],
        image: '/api/placeholder/400/250',
        status: 'draft',
        author: 'Jane Smith',
      ...
      {
        id: '3',
        title: 'Modern Interior Design for Luxury Homes',
        excerpt: 'Explore contemporary design trends for upscale residences.',
        content: 'Lorem ipsum dolor sit amet, consectetur adipiscing elit...',
  ...
  const handleUpdate = (updatedBlog: Blog) => {
    setBlogs(prev => prev.map(blog => 
      blog.id === updatedBlog.id ? { ...updatedBlog, updatedAt: new Date().toISOString().split('T')[0] } : blog
    ));
  ...
  const categories = ['Real Estate Tips', 'Market Analysis', 'Investment Guide', 'Property News', 'Luxury Homes', 'Interior Design'];
        ...
        <div className="max-w-7xl mx-auto">
          <div className="animate-pulse space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {[1, 2, 3, 4, 5, 6].map(i => (
                <div key={i} className="bg-gray-300 dark:bg-gray-700 rounded-2xl h-80"></div>
              ))}
            </div>
          </div>
        </div>
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {filteredBlogs.map((blog) => (
            <div key={blog.id} className="bg-white/70 dark:bg-gray-800/70 backdrop-blur-lg rounded-2xl shadow-xl border border-white/20 dark:border-gray-700/20 overflow-hidden hover:shadow-2xl transition-all duration-300 group">
              <div className="relative">
                <img
                  src={blog.image}
                  alt={blog.title}
              ...
              <div className="p-6">
                ...
                <div className="flex items-center gap-2 mb-4">
                  ...
                  <span className="text-sm text-blue-600 dark:text-blue-400">{blog.category}</span>
                </div>
