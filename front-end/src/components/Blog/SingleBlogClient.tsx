  ...
  return (
    <div className="min-h-screen bg-linear-to-br from-blue-50 via-white to-purple-50 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900">
      <div className="container mx-auto px-4 py-20 max-w-4xl">
        ...
        <Link
          href="/blog"
          className="inline-flex items-center gap-2 mb-4 text-blue-600 dark:text-blue-400 hover:text-blue-800 dark:hover:text-blue-300 transition-colors group"
        >
        ...
        <div className="bg-white/70 dark:bg-gray-800/70 backdrop-blur-lg rounded-3xl shadow-xl border border-white/20 dark:border-gray-700/30 overflow-hidden mb-8">
          ...
          <div className="relative h-64 md:h-80 lg:h-96 overflow-hidden">
            ...
            <div className="absolute top-6 left-6">
              <span className="px-4 py-2 bg-blue-600/90 text-white text-sm font-medium rounded-full backdrop-blur-sm">
                {blog.category}
              </span>
            </div>
          </div>
        ...
        <div className="mt-8 bg-white/70 dark:bg-gray-800/70 backdrop-blur-lg rounded-3xl shadow-xl border border-white/20 dark:border-gray-700/30 p-6">
          ...
          <div className="flex flex-wrap gap-3">
            ...
            <button className="px-4 py-2 bg-blue-800 hover:bg-blue-900 text-white rounded-lg transition-colors flex items-center gap-2">
              Share on Facebook
            </button>
            <button className="px-4 py-2 bg-blue-700 hover:bg-blue-800 text-white rounded-lg transition-colors flex items-center gap-2">
              Share on LinkedIn
            </button>
          </div>
        </div>
